...
const contactLinks = [
  ...
  {
    label: '+977-9803350658',
    href: 'tel:+9779803350658',
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" className="w-4 h-4 shrink-0">
          ...
          <div className="ft-col-brand">
            ...
            <div className="flex items-center gap-3 mt-3">
              <a
                ...
                className="text-white/30 hover:text-cyan-300 transition-colors duration-200"
              >
                <svg viewBox="0 0 24 24" className="w-6 h-6 block" fill="currentColor">
              ...
              <a
                href="https://www.linkedin.com/company/cloud-axis-nepal/"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="Cloud Axis on LinkedIn"
                className="text-white/30 hover:text-cyan-300 transition-colors duration-200"
              >
                <svg viewBox="0 0 24 24" className="w-6 h-6 block" fill="currentColor">
